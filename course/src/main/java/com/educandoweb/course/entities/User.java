...
public class User implements Serializable {
	...
	@OneToMany(mappedBy = "client") // mapeado pelo atributo "client" (olhar na entidade Order)
	private List<Order> orders = new ArrayList<>(); // nome de papel (relações entre as classes)
